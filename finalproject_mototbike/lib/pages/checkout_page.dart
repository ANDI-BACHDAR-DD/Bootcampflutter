...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget buildDetails() {
    return Container(
      ...
      child: Column(
        children: [
          buildItemDetail1('Price', 'IDR 535.000', '/day'),
          const Gap(14),
          ...
          buildItemDetail2('Sub Total Price', 'IDR 8.025.000'),
          const Gap(14),
          buildItemDetail2('Insurance 20%', 'IDR 1.605.000'),
          const Gap(14),
          buildItemDetail2('Tax 20%', ' IDR 321.000'),
          const Gap(14),
          buildItemDetail3(
            'Grand Total',
            NumberFormat.currency(
